...
from main_backend.agent.prompts import SystemPrompt
from main_backend.agent.views import ActionResult
from main_backend.browser.views import BrowserState, TabInfo
from main_backend.dom.views import DOMElementNode, DOMTextNode
...
def test_token_overflow_handling_with_real_flow(message_manager: MessageManager, max_tokens):
	...
	for i in range(200):  # Simulate 40 steps of interaction
		...
		from main_backend.agent.views import AgentBrain, AgentOutput
