...
from main_backend.agent.message_manager.service import MessageManager
from main_backend.agent.prompts import AgentMessagePrompt, SystemPrompt
from main_backend.agent.views import (
	ActionResult,
	AgentError,
	AgentHistory,
	AgentHistoryList,
...
from main_backend.browser.views import BrowserState, BrowserStateHistory
from main_backend.controller.registry.views import ActionModel
from main_backend.controller.service import Controller
from main_backend.dom.history_tree_processor.service import (
	DOMHistoryElement,
	HistoryTreeProcessor,
)
from main_backend.telemetry.service import ProductTelemetry
from main_backend.telemetry.views import (
	AgentEndTelemetryEvent,
	AgentRunTelemetryEvent,
	AgentStepErrorTelemetryEvent,
)
from main_backend.utils import time_execution_async
...
class Agent:
	...
	def add_user_and_assistant_turn(self, user_input, assistant_output):
		self.message_manager.add_user_and_assistant_turn(user_input, assistant_output)
